...
> ⚠️ **Это версия 1. Она больше не поддерживается.**
> Актуальная модель — в `Docs/OOUX v2/`. Сверка v1 против кода от 11.09.2026 нашла
> 148 расхождений, включая секцию, существовавшую в коде и ни в одном документе.
> v1 сохранён как исторический слепок; читать его как описание системы нельзя.
> В частности, таблица «Расхождения с текущей реализацией» в `BACKLOG.md` ссылается
> на файлы, которых в проекте больше нет.
